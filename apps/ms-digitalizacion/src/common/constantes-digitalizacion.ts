...
export class ConstantesDigitalizacion extends Constantes {
  ...
  public static DIGITALIZACION = {
    ...
    PATTERN: {
      ...
      ACTA_BY_JUNTA_DIGNIDAD_CONTROL_LIST: 'ACTA_BY_JUNTA_DIGNIDAD_CONTROL_LIST',
      ...
      ACTA_BY_DIGNIDAD_CONTROL_LIST: 'ACTA_BY_DIGNIDAD_CONTROL_LIST',
